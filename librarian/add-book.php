                ...
                <div class="col-md-12">
                    <form class="form-horizontal" action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="date" class="form-control" id="book_purchase_date" name="book_purchase_date" placeholder="Book Name">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" id="available_qty" name="available_qty" placeholder="Available Quantity">
                            </div>
                        </div>
                        <div class="form-group">
